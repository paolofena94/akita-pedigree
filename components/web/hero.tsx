...
export function HeroSection() {
  return (
    <section aria-labelledby="hero-heading" className="w-full relative min-h-[calc(100vh-100px)] py-12 flex flex-col items-center justify-center mt-[navbar-height] overflow-hidden">
